...
const PerPageOption = ({perPageHandler, per_page}) => {
  return <div className="form-inline ">
    <div className="form-group">Show 
      <select placeholder="select" className="form-control-sm mx-1 form-control" onChange={perPageHandler} value={per_page} >
